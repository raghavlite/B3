...
TASK_INST_QRY = "Represent the given image for classification"
TASK_INST_TGT = ""
@add_metainfo_hook
...
DATASET_PARSER_NAME = "mmeb_cls"
DATASET_HF_PATH = "ziyjiang/MMEB_Test_Instruct"
@AutoPairDataset.register(DATASET_PARSER_NAME)
def load_mmeb_cls_dataset(model_args, data_args, training_args, *args, **kwargs):
