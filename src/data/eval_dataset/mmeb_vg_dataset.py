...
def data_prepare(batch_dict, *args, **kwargs):
    ...
    for qry_text, qry_img_path, tgt_img_path in (
            zip(batch_dict["qry_text"], batch_dict['qry_img_path'], batch_dict['tgt_img_path'])):
...
DATASET_PARSER_NAME = "mmeb_vg"
DATASET_HF_PATH = "ziyjiang/MMEB_Test_Instruct"
@AutoPairDataset.register(DATASET_PARSER_NAME)
def load_mmeb_vg_dataset(model_args, data_args, training_args, *args, **kwargs):
